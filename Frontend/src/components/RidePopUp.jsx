...
const RidePopUp = (props) => { 
  return (
    <div>
           <h4 onClick={() =>  {props.setRideNotification(false)   }} className=" text-2xl absolute right-10 top-5"> <i className="ri-arrow-down-s-line"></i></h4>
        <h3 className=" font-semibold mb-5 text-xl">Confirm your Ride</h3>
        <hr></hr>
     <div className='w-full px-3 flex gap-4 justify-between items-center my-5 bg-yellow-400 p-2 rounded-xl'>
    ...
    <hr></hr>
      <div className=''>
       ...
       <div onClick={()=>{props.setRideNotification(false)
        ...
        }} className=' w-full bg-emerald-500 rounded-xl text-black py-2 font-semibold  flex items-center justify-center text-lg'>Accept </div>
       <div onClick={()=>{props.setRideNotification(false) }} className=' w-full bg-gray-400 rounded-xl text-black py-2 font-semibold mt-3  flex items-center justify-center text-lg'>Ignore </div>
    </div>
  )
}
